...
This project uses the **Skills mechanism**, requiring you to first import the `SKILL.md` file into your AI Agent:
...
After import, the AI Agent will automatically read and learn the code generation rules in `SKILL.md` and the API documentation in the `api/` directory.
